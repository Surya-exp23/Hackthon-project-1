...
import { MapPin, AlertTriangle, CheckCircle2, Clock, TrendingUp, List, Map, BarChart2, LogOut, ChevronRight, Zap, Users, Menu, X } from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <aside className={`mobile-sidebar ${isSidebarOpen ? 'open' : ''}`} style={{ width: 220, flexShrink: 0, background: 'var(--surface)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', padding: '24px 16px', position: 'fixed', top: 0, bottom: 0, left: 0, zIndex: 100 }}>
        ...
        <div style={{ display: 'inline-block', padding: '3px 10px', borderRadius: 999, background: 'var(--critical-dim)', border: '1px solid rgba(239,68,68,0.2)', marginBottom: 24, alignSelf: 'flex-start' }}>
      ...
      <main className="mobile-main" style={{ flex: 1, marginLeft: 220, padding: 32, overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, marginBottom: 32 }}>
          ...
          <div>
            <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 32, fontWeight: 900, letterSpacing: '-0.02em', marginBottom: 4 }}>Command Center</h1>
            <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>Real-time overview of all civic issues across the city.</p>
          </div>
        </div>

        {/* Primary metric row */}
        <div className="md:grid-cols-1" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        ...
        <div className="md:grid-cols-1" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 20, marginBottom: 20 }}>
