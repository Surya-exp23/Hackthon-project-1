  ...
  if (!report) {
    return (
      <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16 }}>
        ...
        <Link href="/department/issues" className="btn btn-primary">← Back to Issues</Link>
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', padding: '24px 32px' }}>
      <div style={{ maxWidth: 1080, margin: '0 auto' }}>
        {/* Back */}
        <Link href="/department/issues" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, textDecoration: 'none', color: 'var(--text-secondary)', fontSize: 13, marginBottom: 24 }}>
          <ArrowLeft size={14} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Status update */}
            <div className="card" style={{ padding: 20 }}>
              <p style={{ fontWeight: 700, fontSize: 14, marginBottom: 14 }}>Execute Action</p>
            ...
            <div className="card" style={{ padding: 20 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  ...
                  { label: 'Assigned', value: report.assignedDepartment?.replace('_', ' ') || 'None' }
                ].map(item => (
